...
Depending on the precepts and other details of the ideoligion of a trader, TraderGen will add extra stock to the trader, and restrict certain purchases. Each one of these two features can be enabled or disabled separately.

The Ideology support is fully compatible with editing ideoligions through dev mode. Existing traders will keep the stock they had, but what they are willing to sale or purchase may change. This may lead to some weird results but it should not cause any issues.

You can find a list of all changes below. Although the list mentions memes for easier understanding, changes are actually tied to individual precepts of each meme.

### Vanilla additions

* Traders may have one or more of their preferred apparels in stock. If possible, this apparel will have the color associated with their ideologion.
* Traders may have their venerated animals and their animal products in stock. They will refuse to purchase the meat of their venerated animals 
* Traders without the Cannibal meme will refuse to purchase human leather or meat.
* Ideologies following the Animal personhood meme may have some pet animals in stock. They will also refuse to purchase animal meat.
* Traders with the Blindsight meme can have some blindfolds in stock. They also may have some psytrainers and rarely (if the corresponding mod setting is enabled) a psylink neuroformer in stock.
* Cannibal traders always purchase human leather, and may have human meat in stock. Their settlements may have some human leather items in stock.
* Traders following the Flesh purity meme will refuse to purchase any body modifications.
* Traders from Guilty ideologies will have some medicine in stock. Settlements may also have some medical drugs.
* Traders who believe in the High life meme will have alcohol, social drugs and hard drugs in stock.
* Traders following the Pain is virtue meme may have some torture crowns and slab beds in stock.
...
* Ideologies considering organ trafficking to be abhorrent will never stock or purchase organs. Ideologies that only consider harvesting to be immoral will still purchase organs but they will never have any in stock.
...
* Traders who adhere to the Biological defilers meme will purchase all animals.
* Ideologies following the Biological reconstructors meme will purchase all animals.
* Traders from ideologies with the Bulwark meme will have some armor in stock.
* Traders following the Madness meme have things in stock.
* Traders who follow the Nutrient paste eating: preferred precept will have some nutrient paste in stock. 
* Ideologies following the Gladiator meme will have traders with some melee weapons in stock.
* Ideologies with the Psychic vampirism meme may have some psytrainers and rarely (if the corresponding mod setting is enabled) a psylink neuroformer in stock.
* Traders with the Sadist meme will have some organs in stock.
* Ideologies with the Sharpshooter meme will stock their traders with some ranged weapons.

### Vanilla Ideology Expanded - Memes and Structures additions

* Ideologies with the Anonymity meme will have some apparel that fully covers the head in stock.
* Traders following the Cultured meme may have some books in stock.
...
* Ideologies with the Psychic focus meme may have some psytrainers and rarely (if the corresponding mod setting is enabled) a psylink neuroformer in stock.
* Ideologies with the Serketist structure may have some insect jelly in stock.
* Traders adhering to ideologies with the Sweet teeth meme will have some chocolate in stock. Their settlements will have an assortment of desserts as well.
...
* **[Vanilla Ideology Expanded - Dryads](https://steamcommunity.com/sharedfiles/filedetails/?id=2720631512):**
  ...
  * Traders following the Gauranlen connection: strong precept will also have some gaubric in stock.
...
* **[What's for sale?](https://steamcommunity.com/sharedfiles/filedetails/?id=2396808851):** This mod will also show the extra stock added by TraderGen.
